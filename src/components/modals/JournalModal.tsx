...
import { X, BookOpen, CheckCircle2, UserCheck } from 'lucide-react';
...
export const JournalModal: React.FC<JournalModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const journal: TeachingJournal = {
      ...
      subject: initialData?.subject || defaultSubject || 'Mata Pelajaran',
      topic: topic.trim(),
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="bg-[#0F172A] border border-slate-800 rounded-2xl shadow-2xl w-full max-w-xl my-8 overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Pilih target kelas, tanggal, jam pelajaran, dan materi pokok yang diajarkan
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-slate-300">
          {/* Target Kelas & Tanggal Pelaksanaan */}
