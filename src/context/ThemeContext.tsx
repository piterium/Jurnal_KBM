...
export const THEME_OPTIONS: ThemeOption[] = [
  {
    ...
    category: 'light',
    tagline: 'Latar cerah & navigasi hijau gradient kuning',
    description: 'Tampilan terang modern dengan bilah navigasi bergradasi hijau zamrud ke kuning keemasan, teks tajam, dan serasi dengan lembar cetak dokumen.',
    primaryColor: '#059669',
